				...
				<div className="bg-white rounded-lg shadow-lg p-6 mb-6">
					<div className="flex mb-6 bg-gray-100 rounded-lg p-1">
						<button
							...
							className={`flex-1 py-2 px-4 rounded-md font-medium transition-colors duration-200 ${activeTab === 'wallet'
						...
						<button
							...
							className={`flex-1 py-2 px-4 rounded-md font-medium transition-colors duration-200 ${activeTab === 'zk'
